    ...
    <main class="page catalog-page">
        <section class="clean-block clean-catalog dark" style="background-color:#efe9ef;">
            ...
            <div class="container profile profile-view" id="profile" style="background: #ffffff">
                ...
                <form>
                    <div class="row profile-row" action="#" method="POST">
                        <div class="col-md-4 relative">
                            ...
                            <input class="form-control form-control my-3" type="file" id="ItemImg" name="avatar-file">
                        </div>
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-2">
                                    <label class="col-form-label" for="item-id">Item ID </label>
                                    <input class="form-control item" type="text" id="ItemID" value="<?php echo $inv['ItemID']; ?>" required>
                                </div>
                                <div class="col-md-10">
                                    <label class="col-form-label" for="item-name">Item Name </label>
                                    <input class="form-control item" type="text" id="ItemName" value="<?php echo $inv['ItemName']; ?>" required>
                                </div>
                                <div class="col-md-12">
                                    <label class="col-form-label" for="item-desc">Item Description </label>
                                    <textarea type="text" rows="10" class="form-control" id="ItemDesc" required><?php echo $inv['ItemDesc']; ?></textarea>
                                </div>
                                <div class="col-md-4">
                                    <label class="col-form-label" for="item-qty">Item Quantity </label>
                                    <input class="form-control item" type="text" id="ItemQty" value="<?php echo $inv['ItemQty']; ?>" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="col-form-label" for="item-type">Item Type </label>
                                    <input class="form-control item" type="text" id="ItemType" value="<?php echo $inv['ItemType']; ?>" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="col-form-label" for="item-price">Item Price (in Php) </label>
                                    <input class="form-control item" type="text" id="ItemPrice" value="<?php echo $inv['ItemPrice']; ?>" required>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
