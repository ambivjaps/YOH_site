        ...
        <section class="clean-block clean-form dark" style="height: 990.391px; background-color:#efe9ef; ">
            <div class="container" style="--bs-primary: #fd0d72;--bs-primary-rgb: 253,13,114;--bs-body-bg: #ffffff;">
                ...
                <h2 style="text-align: center;margin-top: -16px;margin-bottom: 25px;font-size: 41px;color:black;;">Reset Password</h2>
                    ...
                    <div class="mb-3"><label class="form-label" for="email" style="color: rgb(111, 66, 193);">Email</label><input class="form-control item" type="text" id="email_address" name="cust_email" placeholder="Email" required autofocus style="margin-bottom: 9px;"></div>
                    <div class="mb-3"></div>
                    <div class="mb-3"></div>
    ...
    if(isset($_POST["recover"])){
        ...
        $query = mysqli_num_rows($sql);
          ...
          if(mysqli_num_rows($sql) <= 0){
            ...
            $mail->setFrom('abellanoj@gmail.com', 'Password Reset');
