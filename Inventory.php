                                ...
                                <form method="POST" action="javascript:void(0);" id="search_form">
                                    ...
                                    <div class="filter-item">  
                                        ...
                                        <li class="list-group-item">
                                            <div class="form-check"><label style="font-weight:bold;"><input class="form-check-input" type="checkbox" value="<?php echo $product->cleanString($category['TypeID']); ?>" <?php echo @$categoryCheck; ?> name="category[]" class="sort_rang category"><?php echo ucfirst($category['ItemType']); ?></label></div>
                                        </li>
                                        <?php } ?>
                                    </div>
                                    </div>
