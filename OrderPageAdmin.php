...
<?php require 'layouts/nav.php';?>
    ...
    <div class="container my-5">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <h6 style="font-weight:bold;"> Due on: <span style="font-weight:lighter;color:indigo;"><?php echo date("F d, Y", strtotime($order['PaymentDue'])); ?></span></h6>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-6">
                   <h3 style="font-size:40px; color:indigo;"><a href="TrackingDetails.php?id=<?php echo $order['OrderID']; ?>" style="text-decoration:none;color:indigo;"><strong> Tracking Details </strong></a></h3><hr style="width:50%;">
