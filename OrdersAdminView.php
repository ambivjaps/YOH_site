                                ...
                                <form method="POST" action="javascript:void(0);" id="search_form">
                                    <div class="filters">
                                        ...
                                        <div class="filter-item">
                                            ...
                                            <button type="submit" class="btn btn-primary mx-1" role="button" style="text-align: center;width: 40px;border-color: indigo;background: indigo;">
                                                <i class="fas fa-search" style="text-align: center;"></i>
                                            </button>
                                            <a class="btn btn-primary mx-1" role="button" style="text-align: center;width: 40px;border-color: indigo;background: indigo;" href="AddOrder.php"><i class="fas fa-plus" style="text-align: center;"></i></a>
                                        </div>
                                            ...
                                            <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-3"><label class="form-check-label" for="formCheck-3" style="font-weight:bold;">Completed</label></div>
                                            <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-4"><label class="form-check-label" for="formCheck-4" style="font-weight:bold;">Pending</label></div> 
                                        </div>
                                    </div>
                            </div>
                        </div>
