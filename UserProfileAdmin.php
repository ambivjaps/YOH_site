    ...
    <div class="container my-5">
        ...
        <div class="row my-3">
            ...
            <div class="col-md-10">
                ...
                <p style="font-weight:bold;"> Mobile Number: <span style="font-weight:lighter;color:indigo;"><?php echo $user['cust_phone'] ?></span> </p>
                <p style="font-weight:bold;"> E-mail Address: <span style="font-weight:lighter;color:indigo;"><?php echo $user['cust_email'] ?></span> </p>
