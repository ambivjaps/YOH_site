...
<?php 
     if(isset($_POST['edit_user'])) {
        ...
        $query = "UPDATE register SET cust_name='$cust_name', cust_address='$cust_address', cust_city='$cust_city', cust_reg='$cust_reg', cust_zip='$cust_zip', cust_phone='$cust_phone' WHERE login_id=$UID";
        $query_run = mysqli_query($con, $query);
...
<?php require 'layouts/nav.php';?>
    ...
    <?php if($user): ?>
        ...
        <button class="btn btn-primary pull-right" type="button" style="font-weight:bold;border-color:indigo;background:indigo;width:40px;"><a href="UserProfileAdmin.php" style="text-decoration:none;color:white;"><i class="fa fa-arrow-left"></i></a></button></span> </h1><hr>
