...
if (isset($_POST['cust_name'])) {
    ...
    if($reg==1){
        $cquery = "insert into cust_profile (c_id,login_id,c_name,c_avatar,c_label,email,region,street,city,barangay,unit_no,phone_no,zip_code,address,status) values
